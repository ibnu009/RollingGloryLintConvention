...
const _desc = r'Response file must always end with "_response". ';

const _details =
    '''
Response file must always end with "_response" and should always use snake case for file naming.
