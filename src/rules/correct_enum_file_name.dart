...
class CorrectEnumFileName extends LintRule {
  static const LintCode code = LintCode('correct_enum_file_name',
      "The file name '{0}' isn't a correct name for enum file.",
      correctionMessage: 'Try changing the name that ends with "_enum".');

  CorrectEnumFileName()
      : super(
            name: 'correct_enum_file_name',
            description: _desc,
            details: _details,
            group: Group.style);
