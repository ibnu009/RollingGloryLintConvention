...
const _desc = r'The file name for constants must end with _constant.dart';

const _details = r'''
**CAUTION** ...
The file name for constants must end with _constant.dart

**DO:**
```dart
product_constant.dart
```

**DON'T:**
```dart
product.dart
productconstants.dart
```
