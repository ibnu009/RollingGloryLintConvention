...
const _desc =
    r'You should only use double quotes for strings containing single quotes.';
...
```dart
useStrings(
    'should be should should should should quote',
    r'should be single quote',
    r\'''should be single quotes\''',
    "here's ok",
...
class PreferSingleQuotes extends LintRule {
  static const LintCode code = LintCode(
      'prefer_single_quotes', 'You should use of single quotes.',
      correctionMessage:
          'Should use single quotes unless the string contains single quotes.');
